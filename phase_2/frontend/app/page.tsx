  ...
  const features = [
    {
      ...
      description: 'AI-powered organization that adapts to your workflow and boosts productivity.'
    },
    {
    ...
    },
    {
      ...
      description: 'Enterprise-grade encryption and complete data isolation for every user.'
    },
    {
      icon: <Sparkles className="w-8 h-8 text-neon-pink" />,
      title: 'Beautiful Interface',
      description: 'Stunning, futuristic design that makes task management enjoyable.'
    }
  ]
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Advanced features designed to revolutionize how you manage tasks and boost productivity.
          </p>
        </motion.div>
            ...
            <div className="relative bg-dark-card/30 backdrop-blur-xl border border-neon-purple/30 rounded-3xl p-12">
                <>
                  ...
                  <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                    Join thousands of users already experiencing the future of task management.
                  </p>
                  <Link
                    href="/signup"
      ...
      <footer className="relative z-10 border-t border-dark-border bg-dark-card/30 backdrop-blur-md py-8 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-center text-gray-500 text-sm">
            © 2025 TaskFlow AI. Powered by Muniza Nabeel with Next.js, FastAPI, and AI technology.
          </p>
        </div>
      </footer>
    </div>
